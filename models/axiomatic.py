...
class ModelAxiomatic:
    ...
    def minimax(self):
        ...
        #   2. If rule #1 is not fulfilled, check if the user could win for the next move. If possible, occupy that place to prevent the user from winning.
        ...
        #   4. If rule #3 is not fulfilled, check if there is a place where the user could make multiple chances to win in the several direction at user's next turn.
        #      If there are many, occupy a place from random.choice.
        #   5. If rule #4 is not fulfilled, check if there is a place from which the empty tiles can be filled for AI to make a win. 
        #      Count how many ways for AI to win can be constructed from that place. Occupy the place which has the biggest number of ways for AI to win.
        #   6. If rule #5 is not fulfilled, check if there is a place from which the user can fill the empty tiles to make a win.
        #      Count how many ways for the user to win can be constructed from that place. Occupy the place which has the biggest number of ways for user to win. 
        ...
        #       1. If any rule is fulfilled running down to the 6th from the 1st, return the result as the ai_move.
