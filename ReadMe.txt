# readme.txt 
# Tic-Tac-Toe Game!
# by Chang-Jin Lee in 2025

- This project is to make a simple tic-tac-toe game just for a self-study. 
- There may be some bugs in the codes especially in Monte Carlo Simulation, so that this codes should be used at the user's own risk.
- Reference:
...
A. Develop some strategies for AI to find the optimal action.
    ...
    5. Machine Learning: Make AI learn from experiences or data.
